...
export const B1T = styled(Font)`
font-weight: 300;
font-size: 25px;
`

export const B2 = styled(Font)`
font-weight: 400;
font-size: 20px;
`

export const B2T = styled(Font)`
font-weight: 300;
font-size: 20px;
`

export const B3 = styled(Font)`
font-weight: 400;
font-size: 16px;
`

export const B3T = styled(Font)`
font-weight: 300;
font-size: 16px;
`
